...
public class ViewProductActivity extends JFrame implements ActionListener {
	...
	JComboBox byWhatCB;
	JTable table;
	private JButton buttonLogout, buttonBack, buttonCheck, buttonAddProduct,buttontrigger;
	...
	public ViewProductActivity(JFrame prev, Employee employee) {
		...
		buttontrigger = new JButton("View deleted product");
		buttontrigger.setBounds(Theme.GUI_WIDTH-300,Theme.GUI_HEIGHT-90,230,30);
		buttontrigger.setFont(Theme.FONT_BUTTON);
		buttontrigger.setBackground(Theme.BACKGROUND_BUTTON_PRIMARY);
		buttontrigger.setForeground(Theme.COLOR_BUTTON_PRIMARY);
		buttontrigger.addActionListener(this);
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource().equals(buttonLogout)) {
			...
			if (ae.getSource().equals(buttontrigger)) {
			new ViewDeletedProduct(this, employee).setVisible(true);
		}
