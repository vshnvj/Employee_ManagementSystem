...
class ViewPurchasehistory extends JFrame implements ActionListener {
	...
	private String[] columnNames = {"PurchaseId", "customer name","ProductId", "Cost", "Amount", "Date"};

public ViewPurchasehistory(EmployeeActivity prev, Employee employee){
