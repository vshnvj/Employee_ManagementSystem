...
//SET CLASSPATH=C:\Users\Vaishnavi\Downloads\mysql-connector-java-8.0.22.jar;
public class DBMP {
 ...
 class Theme {
	...
	public static final Color BACKGROUND_HEADER = new Color(255,135,0);
	public static final Color COLOR_TITLE = new Color(30,30,30);
	public static final Color COLOR_BUTTON_PRIMARY = new Color(255, 255, 255);
	public static final Color BACKGROUND_BUTTON_PRIMARY = new Color(255,135,0);
 ...
 class Database {
	public static final String HOST_URI = "jdbc:mysql://localhost:3306/DBLminiproject";
